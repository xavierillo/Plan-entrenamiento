...
function Fn(){var a=window.location.protocol,b=W.getEntriesByType("resource");b=bb(b,function(c){return 0===c.name.indexOf(a+"//fonts.gstatic.com/s/")});
...
try{Sn("//static.doubleclick.net/instream/ad_status.js",a)}catch(b){}Zn.push(Qg.L(function(){if(!($n||"google_ad_status"in window)){try{Yn("//static.doubleclick.net/instream/ad_status.js",a)}catch(b){}$n=!0;L("DCLKSTAT",3)}},5E3))}}
...
F("PL_ATT")&&ho.dispose();for(var a=0,b=Zn.length;a<b;a++)Qg.aa(Zn[a]);Zn.length=0;Xn("//static.doubleclick.net/instream/ad_status.js");$n=!1;L("DCLKSTAT",0);(0,Nd)(op,np);mp&&(mp.removeEventListener("onVideoDataChange",pp),mp.destroy())});
