(function(g){var window=this;'use strict';var LTa=function(a,b){return g.Be(a,b)},MTa=function(a,b){b=b instanceof g.Df?b:g.Jf(b,/^data:image\//i.test(b));
...
g.Ok(a.u,b,c)},NTa=function(a){if(a===g.No)throw Error("ES6 Iteration protocol does NOT adjust control flow when StopIteration is thrown from callback helper functions. If your code relies on this behavior, consider throwing a different error and catching it to terminate iteration.");
throw a;},OTa=function(a){if(a instanceof g.Lo)return a;
...
return c}throw Error("Not implemented");},PTa=function(a,b,c){if(g.Ma(a))try{g.jc(a,b,c)}catch(e){NTa(e)}else for(a=OTa(a);;){var d=void 0;
try{d=a.zj()}catch(e){if(e===g.No)break;throw e;}try{b.call(c,d,void 0,a)}catch(e){NTa(e)}}},QTa=function(a,b){var c=[];
PTa(b,function(d){try{var e=g.ds.prototype.u.call(this,d,!0)}catch(f){if("Storage: Invalid value was encountered"==f)return;throw f;}void 0===e?c.push(d):g.cs(e)&&c.push(d)},a);
return c},RTa=function(a,b){QTa(a,b).forEach(function(c){g.ds.prototype.remove.call(this,c)},a)},STa=function(a){if(a.va){if(a.va.locationOverrideToken)return{locationOverrideToken:a.va.locationOverrideToken};
if(null!=a.va.latitudeE7&&null!=a.va.longitudeE7)return{latitudeE7:a.va.latitudeE7,longitudeE7:a.va.longitudeE7}}return null},TTa=function(a,b){g.Pb(a,b)||a.push(b)},Q6=function(a){var b=0,c;
for(c in a)b++;return b},UTa=function(a){try{return g.B.JSON.parse(a)}catch(b){}a=String(a);
if(/^\s*$/.test(a)?0:/^[\],:{}\s\u2028\u2029]*$/.test(a.replace(/\\["\\\/bfnrtu]/g,"@").replace(/(?:"[^"\\\n\r\u2028\u2029\x00-\x08\x0a-\x1f]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?)[\s\u2028\u2029]*(?=:|,|]|}|$)/g,"]").replace(/(?:^|:|,)(?:[\s\u2028\u2029]*\[)+/g,"")))try{return eval("("+a+")")}catch(b){}throw Error("Invalid JSON string: "+a);},R6=function(a){if(g.B.JSON)try{return g.B.JSON.parse(a)}catch(b){}return UTa(a)},VTa=function(a,b,c,d){var e=new g.Bk(null,void 0);
...
g.mp(b.split(","),g.Ra(LTa,YTa)).forEach(function(c){a.capabilities.add(c)})},XTa=function(a,b){a.experiments.clear();
...
screenId:a.id,loungeToken:a.token,dialId:a.uuid,screenIdType:a.idType}},$Ta=function(a){return new U6(a)},aUa=function(a){return Array.isArray(a)?g.Ym(a,$Ta):[]},W6=function(a){return a?'{name:"'+a.name+'",id:'+a.id.substr(0,6)+"..,token:"+((a.token?".."+a.token.slice(-6):"-")+",uuid:"+(a.uuid?".."+a.uuid.slice(-6):"-")+",idType:"+a.idType+"}"):"null"},X6=function(a){return Array.isArray(a)?"["+g.Ym(a,W6).join(",")+"]":"null"},Y6=function(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,
function(a){var b=16*Math.random()|0;
return("x"==a?b:b&3|8).toString(16)})},bUa=function(a){return g.Ym(a,function(b){return{key:b.id,
name:b.name}})},Z6=function(a,b){return g.Mb(a,function(c){return c||b?!c!=!b?!1:c.id==b.id:!0})},$6=function(a,b){return g.Mb(a,function(c){return V6(c,b)})},cUa=function(){var a=(0,g.ty)();
a&&RTa(a,a.i.Kg(!0))},a7=function(){var a=g.wy("yt-remote-connected-devices")||[];
g.gc(a);return a},dUa=function(a){if(g.Qb(a))return[];
var b=a[0].indexOf("#"),c=-1==b?a[0]:a[0].substring(0,b);return g.Ym(a,function(d,e){return 0==e?d:d.substring(c.length)})},eUa=function(a){g.vy("yt-remote-connected-devices",a,86400)},c7=function(){if(b7)return b7;
...
g.Pb(a,b);g.zy()&&g.ic(a,b);a=dUa(a);if(g.Qb(a))try{g.vu("remote_sid")}catch(c){}else try{g.tu("remote_sid",a.join(","),-1)}catch(c){}},fUa=function(){return g.wy("yt-remote-session-browser-channel")},gUa=function(){return g.wy("yt-remote-local-screens")||[]},hUa=function(){g.vy("yt-remote-lounge-token-expiration",!0,86400)},iUa=function(a){5<a.length&&(a=a.slice(a.length-5));
var b=g.Ym(gUa(),function(d){return d.loungeToken}),c=g.Ym(a,function(d){return d.loungeToken});
g.Zm(c,function(d){return!g.Pb(b,d)})&&hUa();
g.vy("yt-remote-local-screens",a,31536E3)},jUa=function(a,b){g.vy("yt-remote-session-browser-channel",a);
g.vy("yt-remote-session-screen-id",b);a=a7();b=c7();g.Pb(a,b)||a.push(b);eUa(a);d7()},e7=function(a){a||(g.yy("yt-remote-session-screen-id"),g.yy("yt-remote-session-video-id"));
d7();a=a7();g.Tb(a,c7());eUa(a)},kUa=function(){if(!f7){var a=g.ns();
a&&(f7=new g.Yr(a))}},lUa=function(){kUa();
return f7?!!f7.get("yt-remote-use-staging-server"):!1},g7=function(){var a=window.navigator.userAgent.match(/Chrome\/([0-9]+)/);
return a?parseInt(a[1],10):0},mUa=function(a){return!!document.currentScript&&(-1!=document.currentScript.src.indexOf("?"+a)||-1!=document.currentScript.src.indexOf("&"+a))},nUa=function(){return"function"==typeof window.__onGCastApiAvailable?window.__onGCastApiAvailable:null},h7=function(a){a.length?oUa(a.shift(),function(){h7(a)}):i7()},pUa=function(a){return"chrome-extension://"+a+"/cast_sender.js"},oUa=function(a,b,c){var d=document.createElement("script");
d.onerror=b;c&&(d.onload=c);g.Yj(d,g.Mr(a));(document.head||document.documentElement).appendChild(d)},qUa=function(){var a=g7(),b=[];
if(1<a){var c=a-1;b.push("//www.gstatic.com/eureka/clank/"+a+"/cast_sender.js");b.push("//www.gstatic.com/eureka/clank/"+c+"/cast_sender.js")}return b},i7=function(){var a=nUa();
a&&a(!1,"No cast extension found")},j7=function(){if(rUa){var a=2,b=nUa(),c=function(){a--;
0==a&&b&&b(!0)};
window.__onGCastApiAvailable=c;oUa("//www.gstatic.com/cast/sdk/libs/sender/1.0/cast_framework.js",i7,c)}},sUa=function(){j7();
var a=qUa();a.push("//www.gstatic.com/eureka/clank/cast_sender.js");h7(a)},uUa=function(){j7();
var a=qUa();a.push.apply(a,g.ma(tUa.map(pUa)));a.push("//www.gstatic.com/eureka/clank/cast_sender.js");h7(a)},k7=function(a,b,c){g.E.call(this);
...
return g.B.setTimeout(function(){a()},b)},q7=function(a){p7.dispatchEvent(new vUa(p7,a))},vUa=function(a,b){g.ie.call(this,"statevent",a);
this.stat=b},r7=function(a,b,c,d){this.i=a;
this.B=b;this.S=c;this.K=d||1;this.u=45E3;this.C=new g.Pk(this);this.I=new g.Lh;this.I.setInterval(250)},xUa=function(a,b,c){a.Nt=1;
a.Xm=O6(b.clone());a.xq=c;a.D=!0;wUa(a,null)},s7=function(a,b,c,d,e){a.Nt=1;
a.Xm=O6(b.clone());a.xq=null;a.D=c;e&&(a.ON=!1);wUa(a,d)},wUa=function(a,b){a.At=Date.now();
t7(a);a.Ho=a.Xm.clone();P6(a.Ho,"t",a.K);a.vB=0;a.Lf=a.i.sD(a.i.lx()?b:null);0<a.hC&&(a.JA=new l7((0,g.C)(a.SO,a,a.Lf),a.hC));a.C.Qa(a.Lf,"readystatechange",a.yQ);b=a.Wo?g.Ke(a.Wo):{};a.xq?(a.tB="POST",b["Content-Type"]="application/x-www-form-urlencoded",a.Lf.send(a.Ho,a.tB,a.xq,b)):(a.tB="GET",a.ON&&!g.Lg&&(b.Connection="close"),a.Lf.send(a.Ho,a.tB,null,b));a.i.Aj(1)},zUa=function(a,b){var c=a.vB,d=b.indexOf("\n",c);
if(-1==d)return u7;c=Number(b.substring(c,d));if(isNaN(c))return yUa;d+=1;if(d+c>b.length)return u7;b=b.substr(d,c);a.vB=d+c;return b},BUa=function(a,b){a.At=Date.now();
...
a.u;
CUa(a,a.u)},CUa=function(a,b){if(null!=a.Yt)throw Error("WatchDog timer not null");
...
g.fe(a.JA);a.JA=null;a.I.stop();g.bl(a.C);if(a.Lf){var b=a.Lf;a.Lf=null;b.abort();b.dispose()}a.Nj&&(a.Nj=null)},z7=function(a,b){try{a.i.SM(a,b),a.i.Aj(4)}catch(c){}},EUa=function(a,b,c,d,e){if(0==d)c(!1);
...
this.u=new n7},GUa=function(a){var b=B7(a.i,a.Nu,"/mail/images/cleardot.gif");
O6(b);EUa(b.toString(),5E3,(0,g.C)(a.pR,a),3,2E3);a.Aj(1)},D7=function(a){var b=a.i.X;
if(null!=b)q7(5),b?(q7(11),C7(a.i,a,!1)):(q7(12),C7(a.i,a,!0));else if(a.qh=new r7(a,void 0,void 0,void 0),a.qh.Wo=a.iC,b=a.i,b=B7(b,b.lx()?a.Fu:null,a.jC),q7(5),!g.Bc||g.tc(10))P6(b,"TYPE","xmlhttp"),s7(a.qh,b,!1,a.Fu,!1);else{P6(b,"TYPE","html");var c=a.qh;a=!!a.Fu;c.Nt=3;c.Xm=O6(b.clone());BUa(c,a)}},E7=function(a,b,c){this.i=1;
this.u=[];this.C=[];this.D=new n7;this.S=a||null;this.X=null!=b?b:null;this.I=c||!1},HUa=function(a,b){this.i=a;
this.map=b;this.context=null},IUa=function(a,b,c,d){g.ie.call(this,"timingevent",a);
this.size=b;this.Zw=d},JUa=function(a){g.ie.call(this,"serverreachability",a)},MUa=function(a){KUa(a);
if(3==a.i){var b=a.mw++,c=a.Qy.clone();g.Jk(c,"SID",a.B);g.Jk(c,"RID",b);g.Jk(c,"TYPE","terminate");F7(a,c);b=new r7(a,a.B,b,void 0);b.Nt=2;b.Xm=O6(c.clone());MTa(new Image,b.Xm.toString());b.At=Date.now();t7(b)}LUa(a)},NUa=function(a){a.PR(1,0);
a.Qy=B7(a,null,a.kC);G7(a)},KUa=function(a){a.dn&&(a.dn.abort(),a.dn=null);
a.Je&&(a.Je.cancel(),a.Je=null);a.El&&(g.B.clearTimeout(a.El),a.El=null);H7(a);a.Ug&&(a.Ug.cancel(),a.Ug=null);a.zn&&(g.B.clearTimeout(a.zn),a.zn=null)},OUa=function(a,b){if(0==a.i)throw Error("Invalid operation: sending map when state is closed");
a.u.push(new HUa(a.qT++,b));2!=a.i&&3!=a.i||G7(a)},PUa=function(a){var b=0;
a.Je&&b++;a.Ug&&b++;return b},G7=function(a){a.Ug||a.zn||(a.zn=o7((0,g.C)(a.XM,a),0),a.rs=0)},RUa=function(a,b){if(1==a.i){if(!b){a.mw=Math.floor(1E5*Math.random());
b=a.mw++;var c=new r7(a,"",b,void 0);c.Wo=a.Yj;var d=I7(a),e=a.Qy.clone();g.Jk(e,"RID",b);g.Jk(e,"CVER","1");F7(a,e);xUa(c,e,d);a.Ug=c;a.i=2}}else 3==a.i&&(b?QUa(a,b):0==a.u.length||a.Ug||QUa(a))},QUa=function(a,b){if(b)if(6<a.rp){a.u=a.C.concat(a.u);
a.C.length=0;var c=a.mw-1;b=I7(a)}else c=b.S,b=b.xq;else c=a.mw++,b=I7(a);var d=a.Qy.clone();g.Jk(d,"SID",a.B);g.Jk(d,"RID",c);g.Jk(d,"AID",a.Qs);F7(a,d);c=new r7(a,a.B,c,a.rs+1);c.Wo=a.Yj;c.setTimeout(1E4+Math.round(1E4*Math.random()));a.Ug=c;xUa(c,d,b)},F7=function(a,b){a.Mf&&(a=a.Mf.oK())&&g.qe(a,function(c,d){g.Jk(b,d,c)})},I7=function(a){var b=Math.min(a.u.length,1E3),c=["count="+b];
...
return c.join("&")},SUa=function(a){a.Je||a.El||(a.K=1,a.El=o7((0,g.C)(a.WM,a),0),a.Pr=0)},J7=function(a){if(a.Je||a.El||3<=a.Pr)return!1;
a.K++;a.El=o7((0,g.C)(a.WM,a),TUa(a,a.Pr));a.Pr++;return!0},C7=function(a,b,c){a.rB=c;
a.Zj=b.ol;a.I||NUa(a)},H7=function(a){null!=a.Bp&&(g.B.clearTimeout(a.Bp),a.Bp=null)},TUa=function(a,b){var c=5E3+Math.floor(1E4*Math.random());
a.isActive()||(c*=2);return c*b},K7=function(a,b){if(2==b||9==b){var c=null;
a.Mf&&(c=null);var d=(0,g.C)(a.AX,a);c||(c=new g.Bk("//www.google.com/images/cleardot.gif"),O6(c));DUa(c.toString(),1E4,d)}else q7(2);UUa(a,b)},UUa=function(a,b){a.i=0;
a.Mf&&a.Mf.BJ(b);LUa(a);KUa(a)},LUa=function(a){a.i=0;
...
if(""!=d.i)b&&g.Dk(d,b+"."+d.i),g.Ek(d,d.B);else{var e=window.location;d=VTa(e.protocol,b?b+"."+e.hostname:e.hostname,+e.port,c)}a.tv&&g.qe(a.tv,function(f,h){g.Jk(d,h,f)});
g.Jk(d,"VER",a.rp);F7(a,d);return d},VUa=function(){},WUa=function(){this.i=[];
...
e=void 0===e?!1:e;this.va=a;this.I=b;this.B=new g.Xr;this.u=new L7(this.eX,this);this.i=null;this.Z=!1;this.D=null;this.X="";this.S=this.C=0;this.K=[];this.Aa=c;this.oa=d;this.Ba=e},YUa=function(a){return{firstTestResults:[""],
secondTestResults:!a.i.rB,sessionId:a.i.B,arrayId:a.i.Qs}},ZUa=function(a,b){a.S=b||0;
a.u.stop();N7(a);a.i&&(3==a.i.getState()&&RUa(a.i),MUa(a.i));a.S=0},O7=function(a){return!!a.i&&3==a.i.getState()},N7=function(a){if(a.i){var b=a.oa(),c=a.i.Yj||{};
...
method:"POST",context:a,timeout:5E3,withCredentials:!1,onSuccess:g.Ra(a.C,d,!0),onError:g.Ra(a.B,e),onTimeout:g.Ra(a.D,e)};c&&(a.postParams=c,a.headers={"Content-Type":"application/x-www-form-urlencoded"});return g.hu(b,a)},cVa=function(){var a=$Ua;
aVa();S7.push(a);bVa()},T7=function(a,b){aVa();
var c=dVa(a,String(b));g.Qb(S7)?eVa(c):(bVa(),g.jc(S7,function(d){d(c)}))},aVa=function(){S7||(S7=g.Ia("yt.mdx.remote.debug.handlers_")||[],g.Ha("yt.mdx.remote.debug.handlers_",S7,void 0))},eVa=function(a){var b=(U7+1)%50;
U7=b;V7[b]=a;W7||(W7=49==b)},bVa=function(){var a=S7;
if(V7[0]){var b=W7?U7:-1;do{b=(b+1)%50;var c=V7[b];g.jc(a,function(d){d(c)})}while(b!=U7);
V7=Array(50);U7=-1;W7=!1}},dVa=function(a,b){var c=(Date.now()-fVa)/1E3;
c.toFixed&&(c=c.toFixed(3));var d=[];d.push("[",c+"s","] ");d.push("[","yt.mdx.remote","] ");d.push(a+": "+b,"\n");return d.join("")},X7=function(a){g.Q.call(this);
this.I=a;this.screens=[]},gVa=function(a,b){var c=a.get(b.uuid)||a.get(b.id);
if(c)return a=c.name,c.id=b.id||c.id,c.name=b.name,c.token=b.token,c.uuid=b.uuid||c.uuid,c.name!=a;a.screens.push(b);return!0},hVa=function(a,b){var c=a.screens.length!=b.length;
a.screens=g.mp(a.screens,function(f){return!!Z6(b,f)});
for(var d=0,e=b.length;d<e;d++)c=gVa(a,b[d])||c;return c},iVa=function(a,b){var c=a.screens.length;
...
this.u=a;this.i=NaN;Z7(this);this.info("Initializing with "+X6(this.screens))},jVa=function(a){if(a.screens.length){var b=g.Ym(a.screens,function(d){return d.id}),c=Q7(a.u,"/pairing/get_lounge_token_batch");
R7(a.u,c,{screen_ids:b.join(",")},(0,g.C)(a.mS,a),(0,g.C)(a.lS,a))}},Z7=function(a){if(g.O("deprecate_pair_servlet_enabled"))return hVa(a,[]);
var b=aUa(gUa());b=g.mp(b,function(c){return!c.uuid});
return hVa(a,b)},a8=function(a,b){iUa(g.Ym(a.screens,ZTa));
b&&hUa()},c8=function(a,b){g.Q.call(this);
...
else{c=g.ye(b);for(var d=0,e=c.length;d<e;++d)if(!a.i[c[d]]){c=!1;break a}c=!0}c||(b8("Updated online screens: "+g.ni(a.i)),a.i=b,a.ea("screenChange"));kVa(a)},f8=function(a){isNaN(a.B)||g.bu(a.B);
a.B=g.$t((0,g.C)(a.aG,a),0<a.C&&a.C<g.Sa()?2E4:1E4)},b8=function(a){T7("OnlineScreenService",a)},lVa=function(a){var b={};
g.jc(a.I(),function(c){c.token?b[c.token]=c.id:this.ke("Requesting availability of screen w/o lounge token.")});
return b},kVa=function(a){a=g.ye(g.re(a.i,function(b){return b}));
...
X7.call(this,"ScreenService");this.C=a;this.K=b;this.i=this.u=null;this.B=[];this.D={};mVa(this)},oVa=function(a,b,c,d,e,f){a.info("getAutomaticScreenByIds "+c+" / "+b);
c||(c=a.D[b]);var h=a.Fh(),l=c?$6(h,c):null;c&&(a.K||l)||(l=$6(h,b));if(l){l.uuid=b;var m=h8(a,l);d8(a.i,m,function(n){e(n?m:null)})}else c?nVa(a,c,(0,g.C)(function(n){var p=h8(this,new U6({name:d,
screenId:c,loungeToken:n,dialId:b||""}));d8(this.i,p,function(r){e(r?p:null)})},a),f):e(null)},pVa=function(a,b){for(var c=0,d=a.screens.length;c<d;++c)if(a.screens[c].name==b)return a.screens[c];
return null},qVa=function(a,b,c){d8(a.i,b,c)},nVa=function(a,b,c,d){a.info("requestLoungeToken_ for "+b);
...
g.hu(Q7(a.C,"/pairing/get_lounge_token_batch"),e)},rVa=function(a){a.screens=a.u.Fh();
var b=a.D,c={},d;for(d in b)c[b[d]]=d;b=0;for(d=a.screens.length;b<d;++b){var e=a.screens[b];e.uuid=c[e.id]||""}a.info("Updated manual screens: "+X6(a.screens))},mVa=function(a){i8(a);
a.u=new $7(a.C);a.u.subscribe("screenChange",(0,g.C)(a.vS,a));rVa(a);a.K||(a.B=aUa(g.wy("yt-remote-automatic-screen-cache")||[]));i8(a);a.info("Initializing automatic screens: "+X6(a.B));a.i=new c8(a.C,(0,g.C)(a.Fh,a,!0));a.i.subscribe("screenChange",(0,g.C)(function(){this.ea("onlineScreenChange")},a))},h8=function(a,b){var c=a.get(b.id);
c?(c.uuid=b.uuid,b=c):((c=$6(a.B,b.uuid))?(c.id=b.id,c.token=b.token,b=c):a.B.push(b),a.K||sVa(a));i8(a);a.D[b.uuid]=b.id;g.vy("yt-remote-device-id-map",a.D,31536E3);return b},sVa=function(a){a=g.mp(a.B,function(b){return"shortLived"!=b.idType});
g.vy("yt-remote-automatic-screen-cache",g.Ym(a,ZTa))},i8=function(a){a.D=g.wy("yt-remote-device-id-map")||{}},j8=function(a,b,c){g.Q.call(this);
this.Ba=c;this.B=a;this.i=b;this.C=null},k8=function(a,b){a.C=b;
a.ea("sessionScreen",a.C)},tVa=function(a,b){a.C&&(a.C.token=b,h8(a.B,a.C));
a.ea("sessionScreen",a.C)},l8=function(a,b){T7(a.Ba,b)},m8=function(a,b,c){j8.call(this,a,b,"CastSession");
var d=this;this.config_=c;this.u=null;this.oa=(0,g.C)(this.DQ,this);this.Aa=(0,g.C)(this.DW,this);this.Z=g.$t(function(){uVa(d,null)},12E4);
this.K=this.D=this.I=this.S=0;this.va=!1;this.X="unknown"},n8=function(a,b){g.bu(a.K);
a.K=0;0==b?vVa(a):a.K=g.$t(function(){vVa(a)},b)},vVa=function(a){wVa(a,"getLoungeToken");
g.bu(a.D);a.D=g.$t(function(){xVa(a,null)},3E4)},wVa=function(a,b){a.info("sendYoutubeMessage_: "+b+" "+g.ni(void 0));
var c={};c.type=b;a.u?a.u.sendMessage("urn:x-cast:com.google.youtube.mdx",c,g.Ja,(0,g.C)(function(){l8(this,"Failed to send message: "+b+".")},a)):l8(a,"Sending yt message without session: "+g.ni(c))},o8=function(a,b){b?(a.info("onConnectedScreenId_: Received screenId: "+b),a.getScreen()&&a.getScreen().id==b||a.BK(b,function(c){k8(a,c)},function(){return a.zg()},5)):a.zg(Error("Waiting for session status timed out."))},zVa=function(a,b,c){a.info("onConnectedScreenData_: Received screenData: "+JSON.stringify(b));
var d=new U6(b);yVa(a,d,function(e){e?(a.va=!0,h8(a.B,d),k8(a,d),a.X="unknown",n8(a,c)):(g.nt(Error("CastSession, RemoteScreen from screenData: "+JSON.stringify(b)+" is not online.")),a.zg())},5)},uVa=function(a,b){g.bu(a.Z);
a.Z=0;b?a.config_.enableCastLoungeToken&&b.loungeToken?b.deviceId?a.getScreen()&&a.getScreen().uuid==b.deviceId||(b.loungeTokenRefreshIntervalMs?zVa(a,{name:a.i.friendlyName,screenId:b.screenId,loungeToken:b.loungeToken,dialId:b.deviceId,screenIdType:"shortLived"},b.loungeTokenRefreshIntervalMs):(g.nt(Error("No loungeTokenRefreshIntervalMs presents in mdxSessionStatusData: "+JSON.stringify(b)+".")),o8(a,b.screenId))):(g.nt(Error("No device id presents in mdxSessionStatusData: "+JSON.stringify(b)+
".")),o8(a,b.screenId)):o8(a,b.screenId):a.zg(Error("Waiting for session status timed out."))},xVa=function(a,b){g.bu(a.D);
a.D=0;var c=null;if(b)if(b.loungeToken){var d;(null==(d=a.getScreen())?void 0:d.token)==b.loungeToken&&(c="staleLoungeToken")}else c="missingLoungeToken";else c="noLoungeTokenResponse";c?(a.info("Did not receive a new lounge token in onLoungeToken_ with data: "+(JSON.stringify(b)+", error: "+c)),a.X=c,n8(a,3E4)):(tVa(a,b.loungeToken),a.va=!1,a.X="unknown",n8(a,b.loungeTokenRefreshIntervalMs))},yVa=function(a,b,c,d){g.bu(a.I);
a.I=0;qVa(a.B,b,function(e){e||0>d?c(e):a.I=g.$t(function(){yVa(a,b,c,d-1)},300)})},AVa=function(a){g.bu(a.S);
...
return!!(a.config_.enableDialLoungeToken&&(null==(b=a.u)?0:b.getDialAppInfo))},BVa=function(a){a.D=a.B.jI(a.Aa,a.i.label,a.i.friendlyName,q8(a),function(b,c){a.D=g.Ja;
a.oa=!0;k8(a,b);"shortLived"==b.idType&&0<c&&r8(a,c)},function(b){a.D=g.Ja;
a.zg(b)})},CVa=function(a){var b={};
b.pairingCode=a.Aa;b.theme=a.La;lUa()&&(b.env_useStageMdx=1);return g.Gi(b)},s8=function(a){return new Promise(function(b){a.Aa=Y6();
if(a.Ka){var c=new chrome.cast.DialLaunchResponse(!0,CVa(a));b(c);BVa(a)}else a.Z=function(){g.bu(a.X);a.Z=function(){};
a.X=NaN;var d=new chrome.cast.DialLaunchResponse(!0,CVa(a));b(d);BVa(a)},a.X=g.$t(function(){a.Z()},100)})},EVa=function(a,b,c){a.info("initOnConnectedScreenDataPromise_: Received screenData: "+JSON.stringify(b));
var d=new U6(b);return(new Promise(function(e){DVa(a,d,function(f){f?(a.oa=!0,h8(a.B,d),k8(a,d),r8(a,c)):g.nt(Error("DialSession, RemoteScreen from screenData: "+JSON.stringify(b)+" is not online."));e(f)},5)})).then(function(e){return e?new chrome.cast.DialLaunchResponse(!1):s8(a)})},FVa=function(a,b){var c=a.S.receiver.label,d=a.i.friendlyName;
return(new Promise(function(e){oVa(a.B,c,b,d,function(f){f&&f.token&&k8(a,f);e(f)},function(f){l8(a,"Failed to get DIAL screen: "+f);
e(null)})})).then(function(e){return e&&e.token?new chrome.cast.DialLaunchResponse(!1):s8(a)})},DVa=function(a,b,c,d){g.bu(a.I);
a.I=0;qVa(a.B,b,function(e){e||0>d?c(e):a.I=g.$t(function(){DVa(a,b,c,d-1)},300)})},r8=function(a,b){a.info("getDialAppInfoWithTimeout_ "+b);
q8(a)&&(g.bu(a.K),a.K=0,0==b?GVa(a):a.K=g.$t(function(){GVa(a)},b))},GVa=function(a){q8(a)&&a.u.getDialAppInfo(function(b){a.info("getDialAppInfo dialLaunchData: "+JSON.stringify(b));
b=b.extraData||{};var c=null;if(b.loungeToken){var d;(null==(d=a.getScreen())?void 0:d.token)==b.loungeToken&&(c="staleLoungeToken")}else c="missingLoungeToken";c?(a.va=c,r8(a,3E4)):(a.oa=!1,a.va="unknown",tVa(a,b.loungeToken),r8(a,b.loungeTokenRefreshIntervalMs))},function(b){a.info("getDialAppInfo error: "+b);
a.va="noLoungeTokenResponse";r8(a,3E4)})},HVa=function(a){g.bu(a.I);
...
this.config_=b;this.u=a;this.S=b.appId||"233637DE";this.C=b.theme||"cl";this.X=b.disableCastApi||!1;this.I=b.forceMirroring||!1;this.i=null;this.K=!1;this.B=[];this.D=(0,g.C)(this.uV,this)},IVa=function(a,b){return b?g.Mb(a.B,function(c){return V6(b,c.label)},a):null},v8=function(a){T7("Controller",a)},$Ua=function(a){window.chrome&&chrome.cast&&chrome.cast.logMessage&&chrome.cast.logMessage(a)},w8=function(a){return a.K||!!a.B.length||!!a.i},x8=function(a,b,c){b!=a.i&&(g.fe(a.i),(a.i=b)?(c?a.ea("yt-remote-cast2-receiver-resumed",
b.i):a.ea("yt-remote-cast2-receiver-selected",b.i),b.subscribe("sessionScreen",(0,g.C)(a.VM,a,b)),b.subscribe("sessionFailed",function(){return JVa(a,b)}),b.getScreen()?a.ea("yt-remote-cast2-session-change",b.getScreen()):c&&a.i.Rs(null)):a.ea("yt-remote-cast2-session-change",null))},JVa=function(a,b){a.i==b&&a.ea("yt-remote-cast2-session-failed")},KVa=function(a){var b=a.u.iI(),c=a.i&&a.i.i;
a=g.Ym(b,function(d){c&&V6(d,c.label)&&(c=null);var e=d.uuid?d.uuid:d.id,f=IVa(this,d);f?(f.label=e,f.friendlyName=d.name):(f=new chrome.cast.Receiver(e,d.name),f.receiverType=chrome.cast.ReceiverType.CUSTOM);return f},a);
c&&(c.receiverType!=chrome.cast.ReceiverType.CUSTOM&&(c=new chrome.cast.Receiver(c.label,c.friendlyName),c.receiverType=chrome.cast.ReceiverType.CUSTOM),a.push(c));return a},PVa=function(a,b,c,d){d.disableCastApi?y8("Cannot initialize because disabled by Mdx config."):LVa()?MVa(b,d)&&(z8(!0),window.chrome&&chrome.cast&&chrome.cast.isAvailable?NVa(a,c):(window.__onGCastApiAvailable=function(e,f){e?NVa(a,c):(A8("Failed to load cast API: "+f),B8(!1),z8(!1),g.yy("yt-remote-cast-available"),g.yy("yt-remote-cast-receiver"),
OVa(),c(!1))},d.loadCastApiSetupScript?g.Ay("https://www.gstatic.com/cv/js/sender/v1/cast_sender.js"):0<=window.navigator.userAgent.indexOf("Android")&&0<=window.navigator.userAgent.indexOf("Chrome/")&&window.navigator.presentation?60<=g7()&&sUa():!window.chrome||!window.navigator.presentation||0<=window.navigator.userAgent.indexOf("Edge")?i7():89<=g7()?uUa():(j7(),h7(tUa.map(pUa))))):y8("Cannot initialize because not running Chrome")},OVa=function(){y8("dispose");
var a=C8();a&&a.dispose();g.Ha("yt.mdx.remote.cloudview.instance_",null,void 0);QVa(!1);g.Bv(D8);D8.length=0},E8=function(){return!!g.wy("yt-remote-cast-installed")},RVa=function(){var a=g.wy("yt-remote-cast-receiver");
return a?a.friendlyName:null},SVa=function(){y8("clearCurrentReceiver");
g.yy("yt-remote-cast-receiver")},TVa=function(){return E8()?C8()?C8().getCastSession():(A8("getCastSelector: Cast is not initialized."),null):(A8("getCastSelector: Cast API is not installed!"),null)},G8=function(){E8()?C8()?F8()?(y8("Requesting cast selector."),C8().requestSession()):(y8("Wait for cast API to be ready to request the session."),D8.push(g.Av("yt-remote-cast2-api-ready",G8))):A8("requestCastSelector: Cast is not initialized."):A8("requestCastSelector: Cast API is not installed!")},H8=
function(a,b){F8()?C8().setConnectedScreenStatus(a,b):A8("setConnectedScreenStatus called before ready.")},LVa=function(){var a=0<=g.Ab.search(/ (CrMo|Chrome|CriOS)\//);
return g.kj||a},UVa=function(a,b){C8().init(a,b)},MVa=function(a,b){var c=!1;
...
y8("cloudview.createSingleton_: "+c);return c},C8=function(){return g.Ia("yt.mdx.remote.cloudview.instance_")},NVa=function(a,b){B8(!0);
z8(!1);UVa(a,function(c){c?(QVa(!0),g.Cv("yt-remote-cast2-api-ready")):(A8("Failed to initialize cast API."),B8(!1),g.yy("yt-remote-cast-available"),g.yy("yt-remote-cast-receiver"),OVa());b(c)})},y8=function(a){T7("cloudview",a)},A8=function(a){T7("cloudview",a)},B8=function(a){y8("setCastInstalled_ "+a);
g.vy("yt-remote-cast-installed",a)},F8=function(){return!!g.Ia("yt.mdx.remote.cloudview.apiReady_")},QVa=function(a){y8("setApiReady_ "+a);
...
this.B=0;this.C=a;this.I=[];this.D=new WUa;this.u=this.i=null;this.X=(0,g.C)(this.dU,this);this.K=(0,g.C)(this.zw,this);this.S=(0,g.C)(this.cU,this);this.Z=(0,g.C)(this.kU,this);var c=0;a?(c=a.getProxyState(),3!=c&&(a.subscribe("proxyStateChange",this.pG,this),VVa(this))):c=3;0!=c&&(b?this.pG(c):g.$t((0,g.C)(function(){this.pG(c)},this),0));
(a=TVa())&&P8(this,a);this.subscribe("yt-remote-cast2-session-change",this.Z)},R8=function(a){return new I8(a.C.getPlayerContextData())},VVa=function(a){g.jc("nowAutoplaying autoplayDismissed remotePlayerChange remoteQueueChange autoplayModeChange autoplayUpNext previousNextChange multiStateLoopEnabled loopModeChange".split(" "),function(b){this.I.push(this.C.subscribe(b,g.Ra(this.sV,b),this))},a)},WVa=function(a){g.jc(a.I,function(b){this.C.unsubscribeByKey(b)},a);
...
a.C.setPlayerContextData(O8(b));VVa(a)},P8=function(a,b){a.u&&(a.u.removeUpdateListener(a.X),a.u.removeMediaListener(a.K),a.zw(null));
a.u=b;a.u&&(T7("CP","Setting cast session: "+a.u.sessionId),a.u.addUpdateListener(a.X),a.u.addMediaListener(a.K),a.u.media.length&&a.zw(a.u.media[0]))},XVa=function(a){var b=a.i.media,c=a.i.customData;
...
g.Q.call(this);this.D=NaN;this.va=!1;this.S=this.K=this.Z=this.oa=NaN;this.X=[];this.C=this.I=this.B=this.pc=this.i=null;this.Ia=a;this.Ba=d;this.X.push(g.Wu(window,"beforeunload",(0,g.C)(this.hS,this)));this.u=[];this.pc=new I8;this.Ka=b.id;this.Aa=b.idType;this.i=YVa(this,c);this.i.subscribe("handlerOpened",this.hU,this);this.i.subscribe("handlerClosed",this.eU,this);this.i.subscribe("handlerError",this.fU,this);this.i.subscribe("handlerMessage",this.gU,this);this.i.VA(b.token);this.subscribe("remoteQueueChange",
function(){var e=this.pc.videoId;g.zy()&&g.vy("yt-remote-session-video-id",e)},this)},ZVa=function(a){return g.Mb(a.u,function(b){return"LOUNGE_SCREEN"==b.type})},Z8=function(a){T7("conn",a)},YVa=function(a,b){return new M7(Q7(a.Ia,"/bc"),b,!1,function(){return a.nI()},"shortLived"==a.Aa)},$8=function(a,b){a.ea("proxyStateChange",b)},$Va=function(a){a.D=g.$t((0,g.C)(function(){Z8("Connecting timeout");
this.gs(1)},a),2E4)},a9=function(a){g.bu(a.D);
a.D=NaN},b9=function(a){g.bu(a.oa);
a.oa=NaN},aWa=function(a){c9(a);
a.Z=g.$t((0,g.C)(function(){d9(this,"getNowPlaying")},a),2E4)},c9=function(a){g.bu(a.Z);
a.Z=NaN},cWa=function(a,b){var c=null;
if(b){var d=ZVa(a);d&&(c={clientName:d.clientName,deviceMake:d.brand,deviceModel:d.model,osVersion:d.osVersion})}g.Ha("yt.mdx.remote.remoteClient_",c,void 0);b&&(a9(a),b9(a));c=O7(a.i)&&isNaN(a.D);b==c?b&&($8(a,1),d9(a,"getSubtitlesTrack")):b?(a.AK()&&a.pc.reset(),$8(a,1),d9(a,"getNowPlaying"),bWa(a)):a.gs(1)},dWa=function(a,b){var c=b.params.videoId;
delete b.params.videoId;c==a.pc.videoId&&(g.Ee(b.params)?a.pc.trackData=null:a.pc.trackData=b.params,a.ea("remotePlayerChange"))},eWa=function(a,b,c){var d=b.params.videoId||b.params.video_id,e=parseInt(b.params.currentIndex,10);
a.pc.listId=b.params.listId||a.pc.listId;N8(a.pc,d,e);a.ea("remoteQueueChange",c)},gWa=function(a,b){b.params=b.params||{};
eWa(a,b,"NOW_PLAYING_MAY_CHANGE");fWa(a,b);a.ea("autoplayDismissed")},fWa=function(a,b){var c=parseInt(b.params.currentTime||b.params.current_time,10);
L8(a.pc,isNaN(c)?0:c);c=parseInt(b.params.state,10);c=isNaN(c)?-1:c;-1==c&&-1E3==a.pc.playerState&&(c=-1E3);a.pc.playerState=c;c=Number(b.params.loadedTime);a.pc.S=isNaN(c)?0:c;a.pc.Jj(Number(b.params.duration));c=a.pc;var d=Number(b.params.liveIngestionTime);c.B=d;c.u=isNaN(d)?!1:!0;c=a.pc;d=Number(b.params.seekableStartTime);b=Number(b.params.seekableEndTime);c.C=isNaN(d)?0:d;c.i=isNaN(b)?0:b;1==a.pc.playerState?aWa(a):c9(a);a.ea("remotePlayerChange")},hWa=function(a,b){if(-1E3!=a.pc.playerState){var c=
1085;
switch(parseInt(b.params.adState,10)){case 1:c=1081;break;case 2:c=1084;break;case 0:c=1083}a.pc.playerState=c;b=parseInt(b.params.currentTime,10);L8(a.pc,isNaN(b)?0:b);a.ea("remotePlayerChange")}},iWa=function(a,b){var c="true"==b.params.muted;
a.pc.volume=parseInt(b.params.volume,10);a.pc.muted=c;a.ea("remotePlayerChange")},jWa=function(a,b){a.I=b.params.videoId;
a.ea("nowAutoplaying",parseInt(b.params.timeout,10))},kWa=function(a,b){var c="true"==b.params.hasNext;
a.pc.Hk="true"==b.params.hasPrevious;a.pc.hasNext=c;a.ea("previousNextChange")},bWa=function(a){g.bu(a.S);
...
this.Se=a;this.i=[];this.i.push(this.Se.$_s("screenChange",(0,g.C)(this.IQ,this)));this.i.push(this.Se.$_s("onlineScreenChange",(0,g.C)(this.ZU,this)))},oWa=function(a,b){kUa();
if(!f7||!f7.get("yt-remote-disable-remote-module-for-dev")){b=g.N("MDX_CONFIG")||b;cUa();d7();f9||(f9=new P7(b?b.loungeApiHost:void 0),lUa()&&(f9.i="/api/loungedev"));g9||(g9=g.Ia("yt.mdx.remote.deferredProxies_")||[],g.Ha("yt.mdx.remote.deferredProxies_",g9,void 0));lWa();var c=h9();if(!c){var d=new g8(f9,b?b.disableAutomaticScreenCache||!1:!1);g.Ha("yt.mdx.remote.screenService_",d,void 0);c=h9();var e={};b&&(e={appId:b.appId,disableDial:b.disableDial,theme:b.theme,loadCastApiSetupScript:b.loadCastApiSetupScript,
disableCastApi:b.disableCastApi,enableDialLoungeToken:b.enableDialLoungeToken,enableCastLoungeToken:b.enableCastLoungeToken,forceMirroring:b.forceMirroring});g.Ha("yt.mdx.remote.enableConnectWithInitialState_",b?b.enableConnectWithInitialState||!1:!1,void 0);PVa(a,d,function(f){f?i9()&&H8(i9(),"YouTube TV"):d.subscribe("onlineScreenChange",function(){S6("yt-remote-receiver-availability-change")})},e)}b&&!g.Ia("yt.mdx.remote.initialized_")&&(g.Ha("yt.mdx.remote.initialized_",!0,void 0),j9("Initializing: "+
...
S6("yt-remote-auto-connect","cast-selector-receiver")})),k9.push(g.Av("yt-remote-cast2-receiver-resumed",function(){S6("yt-remote-receiver-resumed","cast-selector-receiver")})),k9.push(g.Av("yt-remote-cast2-session-change",mWa)),k9.push(g.Av("yt-remote-connection-change",function(f){f?H8(i9(),"YouTube TV"):m9()||(H8(null,null),SVa())})),k9.push(g.Av("yt-remote-cast2-session-failed",function(){S6("yt-remote-connection-failed")})),a=n9(),b.isAuto&&(a.id+="#dial"),e=b.capabilities||[],g.O("desktop_enable_autoplay")&&
e.push("atp"),0<e.length&&(a.capabilities=e),a.name=b.device,a.app=b.app,(b=b.theme)&&(a.theme=b),j9(" -- with channel params: "+g.ni(a)),a?(g.vy("yt-remote-session-app",a.app),g.vy("yt-remote-session-name",a.name)):(g.yy("yt-remote-session-app"),g.yy("yt-remote-session-name")),g.Ha("yt.mdx.remote.channelParams_",a,void 0),c.start(),i9()||nWa())}},pWa=function(){var a=h9().Se.$_gos();
var b=o9();b&&p9()&&(Z6(a,b)||a.push(b));return bUa(a)},q9=function(){var a=qWa();
!a&&E8()&&RVa()&&(a={key:"cast-selector-receiver",name:RVa()});return a},qWa=function(){var a=pWa(),b=o9();
b||(b=m9());return g.Mb(a,function(c){return b&&V6(b,c.key)?!0:!1})},o9=function(){var a=i9();
if(!a)return null;var b=h9().Fh();return $6(b,a)},mWa=function(a){j9("remote.onCastSessionChange_: "+W6(a));
...
w9=a?new e9(a):null}return w9},i9=function(){return g.Ia("yt.mdx.remote.currentScreenId_")},rWa=function(a){g.Ha("yt.mdx.remote.currentScreenId_",a,void 0)},sWa=function(){return g.Ia("yt.mdx.remote.connectData_")},l9=function(a){g.Ha("yt.mdx.remote.connectData_",a,void 0)},p9=function(){return g.Ia("yt.mdx.remote.connection_")},u9=function(a){var b=p9();
l9(null);a||rWa("");g.Ha("yt.mdx.remote.connection_",a,void 0);g9&&(g.jc(g9,function(c){c(a)}),g9.length=0);
...
o9()&&o9();if(x9)r9=a;else{rWa(a.id);var c=g.Ia("yt.mdx.remote.enableConnectWithInitialState_")||!1;a=new Y8(f9,a,n9(),c);a.connect(b,sWa());a.subscribe("beforeDisconnect",function(d){S6("yt-remote-before-disconnect",d)});
...
u9(a)}},nWa=function(){var a=m9();
a?(j9("Resume connection to: "+W6(a)),t9(a,0)):(e7(),SVa(),j9("Skipping connecting because no session screen found."))},lWa=function(){var a=n9();
...
var d=this;this.u=a;this.J=b;this.Ub=c;this.events=new g.KC(this);this.Z=this.events.T(this.J,"onVolumeChange",function(e){tWa(d,e)});
...
a=this.Ub;a.isDisposed();a.subscribe("proxyStateChange",this.RM,this);a.subscribe("remotePlayerChange",this.Ew,this);a.subscribe("remoteQueueChange",this.oA,this);a.subscribe("previousNextChange",this.OM,this);a.subscribe("nowAutoplaying",this.HM,this);a.subscribe("autoplayDismissed",this.kM,this);g.H(this,this.i);g.H(this,this.B);g.H(this,this.S);g.H(this,this.X);g.H(this,this.K);this.gO();this.oA();this.Ew()},tWa=function(a,b){if(z9(a)){a.Ub.unsubscribe("remotePlayerChange",a.Ew,a);
var c=Math.round(b.volume);b=!!b.muted;var d=R8(a.Ub);if(c!==d.volume||b!==d.muted)a.Ub.setVolume(c,b),a.X.start();a.Ub.subscribe("remotePlayerChange",a.Ew,a)}},uWa=function(a){a.Yb(0);
...
if(null===c||void 0===c?0:c.listId){var d=c.index;var e=c.listId.toString()}c=a.J.getVideoData(1);a.Ub.playVideo(c.videoId,b,d,e,c.playerParams,c.Za,STa(c));a.Vb(new g.tJ(1))},vWa=function(a,b){if(b){var c=a.J.getOption("captions","tracklist",{YK:1});
...
"ytp-mdx-privacy-popup-cancel"],ya:"Cancelar"},{G:"button",Ha:["ytp-button","ytp-mdx-privacy-popup-confirm"],ya:"Confirmar"}]}]}]});this.i=new g.ZK(this,250);this.cancelButton=this.Fa("ytp-mdx-privacy-popup-cancel");this.confirmButton=this.Fa("ytp-mdx-privacy-popup-confirm");g.H(this,this.i);this.T(this.cancelButton,"click",this.u);this.T(this.confirmButton,"click",this.B)},D9=function(a){g.W.call(this,{G:"div",
L:"ytp-remote",U:[{G:"div",L:"ytp-remote-display-status",U:[{G:"div",L:"ytp-remote-display-status-icon",U:[g.yua()]},{G:"div",L:"ytp-remote-display-status-text",ya:"{{statustext}}"}]}]});this.api=a;this.i=new g.ZK(this,250);g.H(this,this.i);this.T(a,"presentingplayerstatechange",this.onStateChange);wWa(this,a.zb())},wWa=function(a,b){if(3===a.api.getPresentingPlayerType()){var c={RECEIVER_NAME:a.api.getOption("remote","currentReceiver").name};
b=g.T(b,128)?g.BH("Error en $RECEIVER_NAME",c):b.Fc()||g.T(b,4)?g.BH("Reproduciendo en $RECEIVER_NAME",c):g.BH("Conectado a $RECEIVER_NAME",c);a.Ra("statustext",b);a.i.show()}else a.i.hide()},E9=function(a,b){g.uP.call(this,"Reproducir en",0,a,b);
...
n7.prototype.parse=function(a){return g.B.JSON.parse(a,void 0)};var p7=new g.ef;g.v(vUa,g.ie);g.k=r7.prototype;g.k.Wo=null;g.k.Hm=!1;g.k.Yt=null;g.k.hH=null;g.k.At=null;g.k.Nt=null;g.k.Xm=null;g.k.Ho=null;g.k.xq=null;g.k.Lf=null;g.k.vB=0;g.k.Nj=null;g.k.tB=null;g.k.Qm=null;g.k.Eu=-1;g.k.ON=!0;g.k.qp=!1;g.k.hC=0;g.k.JA=null;var yUa={},u7={};g.k=r7.prototype;g.k.setTimeout=function(a){this.u=a};
g.k.yQ=function(a){a=a.target;var b=this.JA;b&&3==g.Vi(a)?b.hI():this.SO(a)};
g.k.SO=function(a){try{if(a==this.Lf)a:{var b=g.Vi(this.Lf),c=this.Lf.u,d=this.Lf.getStatus();if(g.Bc&&!g.tc(10)||g.Lg&&!g.sc("420+")){if(4>b)break a}else if(3>b||3==b&&!g.$i(this.Lf))break a;this.qp||4!=b||7==c||(8==c||0>=d?this.i.Aj(3):this.i.Aj(2));y7(this);var e=this.Lf.getStatus();this.Eu=e;var f=g.$i(this.Lf);if(this.Hm=200==e){4==b&&v7(this);if(this.D){for(a=!0;!this.qp&&this.vB<f.length;){var h=zUa(this,f);if(h==u7){4==b&&(this.Qm=4,q7(15),a=!1);break}else if(h==yUa){this.Qm=4;q7(16);a=!1;
...
g.k.xW=function(){this.Yt=null;var a=Date.now();0<=a-this.hH?(2!=this.Nt&&this.i.Aj(3),v7(this),this.Qm=2,q7(18),w7(this)):CUa(this,this.hH-a)};
g.k.getLastError=function(){return this.Qm};g.k=FUa.prototype;g.k.iC=null;g.k.qh=null;g.k.KA=!1;g.k.bO=null;g.k.Py=null;g.k.KE=null;g.k.jC=null;g.k.Wh=null;g.k.ol=-1;g.k.Fu=null;g.k.Nu=null;g.k.connect=function(a){this.jC=a;a=B7(this.i,null,this.jC);q7(3);this.bO=Date.now();var b=this.i.S;null!=b?(this.Fu=b[0],(this.Nu=b[1])?(this.Wh=1,GUa(this)):(this.Wh=2,D7(this))):(P6(a,"MODE","init"),this.qh=new r7(this,void 0,void 0,void 0),this.qh.Wo=this.iC,s7(this.qh,a,!1,null,!0),this.Wh=0)};
...
g.k.Wx=function(){this.ol=this.qh.Eu;if(this.qh.Hm)0==this.Wh?this.Nu?(this.Wh=1,GUa(this)):(this.Wh=2,D7(this)):2==this.Wh&&((!g.Bc||g.tc(10)?!this.KA:200>this.KE-this.Py)?(q7(11),C7(this.i,this,!1)):(q7(12),C7(this.i,this,!0)));else{0==this.Wh?q7(9):2==this.Wh&&q7(10);var a=this.i;this.qh.getLastError();a.Zj=this.ol;K7(a,2)}};
g.k.lx=function(){return this.i.lx()};
g.k.isActive=function(){return this.i.isActive()};
g.k.Aj=function(a){this.i.Aj(a)};g.k=E7.prototype;g.k.Yj=null;g.k.tv=null;g.k.Ug=null;g.k.Je=null;g.k.kC=null;g.k.Qy=null;g.k.lJ=null;g.k.Xx=null;g.k.mw=0;g.k.qT=0;g.k.Mf=null;g.k.zn=null;g.k.El=null;g.k.Bp=null;g.k.dn=null;g.k.rB=null;g.k.Qs=-1;g.k.yL=-1;g.k.Zj=-1;g.k.rs=0;g.k.Pr=0;g.k.rp=8;g.Ta(IUa,g.ie);g.Ta(JUa,g.ie);g.k=E7.prototype;g.k.connect=function(a,b,c,d,e){q7(0);this.kC=b;this.tv=c||{};d&&void 0!==e&&(this.tv.OSID=d,this.tv.OAID=e);this.I?(o7((0,g.C)(this.HJ,this,a),100),NUa(this)):this.HJ(a)};
g.k.HJ=function(a){this.dn=new FUa(this);this.dn.iC=this.Yj;this.dn.u=this.D;this.dn.connect(a)};
g.k.sf=function(){return 0==this.i};
g.k.getState=function(){return this.i};
g.k.XM=function(a){this.zn=null;RUa(this,a)};
g.k.WM=function(){this.El=null;this.Je=new r7(this,this.B,"rpc",this.K);this.Je.Wo=this.Yj;this.Je.hC=0;var a=this.lJ.clone();g.Jk(a,"RID","rpc");g.Jk(a,"SID",this.B);g.Jk(a,"CI",this.rB?"0":"1");g.Jk(a,"AID",this.Qs);F7(this,a);if(!g.Bc||g.tc(10))g.Jk(a,"TYPE","xmlhttp"),s7(this.Je,a,!0,this.Xx,!1);else{g.Jk(a,"TYPE","html");var b=this.Je,c=!!this.Xx;b.Nt=3;b.Xm=O6(a.clone());BUa(b,c)}};
...
a&&H7(this),!g.jb(b))for(a=this.D.parse(b),b=0;b<a.length;b++)c=a[b],this.Qs=c[0],c=c[1],2==this.i?"c"==c[0]?(this.B=c[1],this.Xx=c[2],c=c[3],null!=c?this.rp=c:this.rp=6,this.i=3,this.Mf&&this.Mf.DJ(),this.lJ=B7(this,this.lx()?this.Xx:null,this.kC),SUa(this)):"stop"==c[0]&&K7(this,7):3==this.i&&("stop"==c[0]?K7(this,7):"noop"!=c[0]&&this.Mf&&this.Mf.CJ(c),this.Pr=0)};
g.k.VT=function(){null!=this.Bp&&(this.Bp=null,this.Je.cancel(),this.Je=null,J7(this),q7(20))};
g.k.Wx=function(a){if(this.Je==a){H7(this);this.Je=null;var b=2}else if(this.Ug==a)this.Ug=null,b=1;else return;this.Zj=a.Eu;if(0!=this.i)if(a.Hm)if(1==b){b=Date.now()-a.At;var c=p7;c.dispatchEvent(new IUa(c,a.xq?a.xq.length:0,b,this.rs));G7(this);this.C.length=0}else SUa(this);else{c=a.getLastError();var d;if(!(d=3==c||7==c||0==c&&0<this.Zj)){if(d=1==b)this.Ug||this.zn||1==this.i||2<=this.rs?d=!1:(this.zn=o7((0,g.C)(this.XM,this,a),TUa(this,this.rs)),this.rs++,d=!0);d=!(d||2==b&&J7(this))}if(d)switch(c){case 1:K7(this,
...
g.k.AX=function(a){a?q7(2):(q7(1),UUa(this,8))};
...
g.k.Aj=function(a){var b=p7;b.dispatchEvent(new JUa(b,a))};
g.k.lx=function(){return!(!g.Bc||g.tc(10))};
g.k=VUa.prototype;g.k.DJ=function(){};
g.k.CJ=function(){};
g.k.BJ=function(){};
g.k.fD=function(){};
...
g.k.isActive=function(){return this.i.isActive()};
g.k.reset=function(){this.i.stop();this.Vf=5E3};g.Ta(M7,VUa);g.k=M7.prototype;g.k.subscribe=function(a,b,c){return this.B.subscribe(a,b,c)};
...
g.k.dispose=function(){this.Z||(this.Z=!0,g.fe(this.B),ZUa(this),g.fe(this.u),this.u=null,this.oa=function(){return""})};
g.k.isDisposed=function(){return this.Z};
g.k.connect=function(a,b,c){if(!this.i||2!=this.i.getState()){this.X="";this.u.stop();this.D=a||null;this.C=b||0;a=this.va+"/test";b=this.va+"/bind";var d=new E7(c?c.firstTestResults:null,c?c.secondTestResults:null,this.Aa),e=this.i;e&&(e.Mf=null);d.Mf=this;this.i=d;N7(this);if(this.i){d=g.N("ID_TOKEN");var f=this.i.Yj||{};d?f["x-youtube-identity-token"]=d:delete f["x-youtube-identity-token"];this.i.Yj=f}e?(3!=e.getState()&&0==PUa(e)||e.getState(),this.i.connect(a,b,this.I,e.B,e.Qs)):c?this.i.connect(a,
b,this.I,c.sessionId,c.arrayId):this.i.connect(a,b,this.I)}};
g.k.sendMessage=function(a,b){a={_sc:a};b&&g.Ne(a,b);this.u.isActive()||2==(this.i?this.i.getState():0)?this.K.push(a):O7(this)&&(N7(this),OUa(this.i,a))};
g.k.DJ=function(){this.u.reset();this.D=null;this.C=0;if(this.K.length){var a=this.K;this.K=[];for(var b=0,c=a.length;b<c;++b)OUa(this.i,a[b])}this.ea("handlerOpened")};
...
g.k.CJ=function(a){"S"==a[0]?this.X=a[1]:"gracefulReconnect"==a[0]?(this.u.start(),MUa(this.i)):this.ea("handlerMessage",new XUa(a[0],a[1]))};
...
g.k.eX=function(){this.u.isActive();0==PUa(this.i)&&this.connect(this.D,this.C)};P7.prototype.C=function(a,b,c,d){b?a(d):a({text:c.responseText})};
P7.prototype.B=function(a,b){a(Error("Request error: "+b.status))};
P7.prototype.D=function(a){a(Error("request timed out"))};var fVa=Date.now(),S7=null,V7=Array(50),U7=-1,W7=!1;g.Ta(X7,g.Q);X7.prototype.Fh=function(){return this.screens};
...
g.k.zQ=function(a){this.i=null;a.status&&404==a.status?this.u>=zWa.length?this.ea("pairingFailed",Error("DIAL polling timed out")):(a=zWa[this.u],this.Nb=g.$t((0,g.C)(this.jN,this),a),this.u++):this.ea("pairingFailed",Error("Server error "+a.status))};
g.k.BQ=function(){this.i=null;this.ea("pairingFailed",Error("Server not responding"))};
var zWa=[2E3,2E3,1E3,1E3,1E3,2E3,2E3,5E3,5E3,1E4];g.Ta($7,X7);g.k=$7.prototype;g.k.start=function(){Z7(this)&&this.ea("screenChange");!g.wy("yt-remote-lounge-token-expiration")&&jVa(this);g.bu(this.i);this.i=g.$t((0,g.C)(this.start,this),1E4)};
g.k.add=function(a,b){Z7(this);gVa(this,a);a8(this,!1);this.ea("screenChange");b(a);a.token||jVa(this)};
g.k.remove=function(a,b){var c=Z7(this);iVa(this,a)&&(a8(this,!1),c=!0);b(a);c&&this.ea("screenChange")};
...
g.k.aG=function(){g.bu(this.B);this.B=NaN;this.u&&this.u.abort();var a=lVa(this);if(Q6(a)){var b=Q7(this.D,"/pairing/get_screen_availability");this.u=R7(this.D,b,{lounge_token:g.ye(a).join(",")},(0,g.C)(this.OV,this,a),(0,g.C)(this.NV,this))}else e8(this,{}),f8(this)};
g.k.OV=function(a,b){this.u=null;var c=g.ye(lVa(this));if(g.hc(c,g.ye(a))){b=b.screens||[];c={};for(var d=0,e=b.length;d<e;++d)c[a[b[d].loungeToken]]="online"==b[d].status;e8(this,c);f8(this)}else this.ke("Changing Screen set during request."),this.aG()};
...
g.k.CQ=function(a,b,c,d){g.hu(Q7(this.C,"/pairing/get_screen"),{method:"POST",postParams:{pairing_code:a},timeout:5E3,onSuccess:(0,g.C)(function(e,f){e=new U6(f.screen||{});if(!e.name||pVa(this,e.name)){a:{f=e.name;for(var h=2,l=b(f,h);pVa(this,l);){h++;if(20<h)break a;l=b(f,h)}f=l}e.name=f}c(h8(this,e))},this),
...
g.k.vS=function(){rVa(this);this.ea("screenChange");this.i.update()};
...
g.k.xa=function(){this.oG("");j8.je.xa.call(this)};g.v(m8,j8);g.k=m8.prototype;g.k.nG=function(a){if(this.u){if(this.u==a)return;l8(this,"Overriding cast session with new session object");AVa(this);this.va=!1;this.X="unknown";this.u.removeUpdateListener(this.oa);this.u.removeMessageListener("urn:x-cast:com.google.youtube.mdx",this.Aa)}this.u=a;this.u.addUpdateListener(this.oa);this.u.addMessageListener("urn:x-cast:com.google.youtube.mdx",this.Aa);wVa(this,"getMdxSessionStatus")};
...
g.k.oG=function(){};
g.k.xa=function(){this.info("disposeInternal");AVa(this);this.u&&(this.u.removeUpdateListener(this.oa),this.u.removeMessageListener("urn:x-cast:com.google.youtube.mdx",this.Aa));this.u=null;j8.prototype.xa.call(this)};
g.k.DW=function(a,b){if(!this.isDisposed())if(b)if(b=R6(b),g.Na(b))switch(a=""+b.type,b=b.data||{},this.info("onYoutubeMessage_: "+a+" "+g.ni(b)),a){case "mdxSessionStatus":uVa(this,b);break;case "loungeToken":xVa(this,b);break;default:l8(this,"Unknown youtube message: "+a)}else l8(this,"Unable to parse message.");else l8(this,"No data in message.")};
g.k.BK=function(a,b,c,d){g.bu(this.S);this.S=0;oVa(this.B,this.i.label,a,this.i.friendlyName,(0,g.C)(function(e){e?b(e):0<=d?(l8(this,"Screen "+a+" appears to be offline. "+d+" retries left."),this.S=g.$t((0,g.C)(this.BK,this,a,b,c,d-1),300)):c(Error("Unable to fetch screen."))},this),c)};
...
g.k.stop=function(){HVa(this);this.u?this.u.stop((0,g.C)(this.zg,this,null),(0,g.C)(this.zg,this,"Failed to stop DIAL device.")):this.zg()};
g.k.xa=function(){HVa(this);this.u&&this.u.removeUpdateListener(this.Ia);this.u=null;j8.prototype.xa.call(this)};
...
chrome.cast.initialize(c,(0,g.C)(function(){this.isDisposed()||(chrome.cast.addReceiverActionListener(this.D),cVa(),this.u.subscribe("onlineScreenChange",(0,g.C)(this.lI,this)),this.B=KVa(this),chrome.cast.setCustomReceivers(this.B,g.Ja,(0,g.C)(function(f){this.ke("Failed to set initial custom receivers: "+g.ni(f))},this)),this.ea("yt-remote-cast2-availability-change",w8(this)),b(!0))},this),(0,g.C)(function(f){this.ke("Failed to initialize API: "+g.ni(f));
b(!1)},this))};
g.k.jX=function(a,b){v8("Setting connected screen ID: "+a+" -> "+b);if(this.i){var c=this.i.getScreen();if(!a||c&&c.id!=a)v8("Unsetting old screen status: "+this.i.i.friendlyName),x8(this,null)}if(a&&b){if(!this.i){c=$6(this.u.Fh(),a);if(!c){v8("setConnectedScreenStatus: Unknown screen.");return}if("shortLived"==c.idType){v8("setConnectedScreenStatus: Screen with id type to be short lived.");return}a=IVa(this,c);a||(v8("setConnectedScreenStatus: Connected receiver not custom..."),a=new chrome.cast.Receiver(c.uuid?
...
g.k.xa=function(){this.u.unsubscribe("onlineScreenChange",(0,g.C)(this.lI,this));window.chrome&&chrome.cast&&chrome.cast.removeReceiverActionListener(this.D);var a=$Ua,b=g.Ia("yt.mdx.remote.debug.handlers_");g.Tb(b||[],a);g.fe(this.i);g.Q.prototype.xa.call(this)};
...
screenIdType:"shortLived"},a.loungeTokenRefreshIntervalMs):(g.nt(Error("No loungeTokenRefreshIntervalMs presents in additionalData: "+JSON.stringify(a)+".")),a=FVa(b,c)):a=FVa(b,c)):a=s8(b);return a};
...
g.k.lI=function(){this.isDisposed()||(this.B=KVa(this),v8("Updating custom receivers: "+g.ni(this.B)),chrome.cast.setCustomReceivers(this.B,g.Ja,(0,g.C)(function(){this.ke("Failed to set custom receivers.")},this)),this.ea("yt-remote-cast2-availability-change",w8(this)))};
...
g.k.xa=function(){WVa(this);this.C=null;this.D.clear();P8(this,null);g.Q.prototype.xa.call(this)};
...
g.k.zw=function(a){T7("CP","Cast media: "+!!a);this.i&&this.i.removeUpdateListener(this.S);if(this.i=a)this.i.addUpdateListener(this.S),XVa(this),this.ea("remotePlayerChange")};
g.k.cU=function(a){a?(XVa(this),this.ea("remotePlayerChange")):this.zw(null)};
g.k.KG=function(){W8(this,"sendDebugCommand",{debugCommand:"stats4nerds "})};
g.k.kU=function(){var a=TVa();a&&P8(this,a)};
...
n);this.C="UNSUPPORTED";c=this.Ba?"setInitialState":"setPlaylist";Z8("Connecting with "+c+" and params: "+g.ni(m));this.i.connect({method:c,params:g.ni(m)},a,fUa())}else Z8("Connecting without params"),this.i.connect({},a,fUa());$Va(this)};
...
cWa(this,a);a=this.jL("mlm");this.ea("multiStateLoopEnabled",a);break;case "loungeScreenDisconnected":g.Ub(this.u,function(c){return"LOUNGE_SCREEN"==c.type});
cWa(this,!1);break;case "remoteConnected":var b=new T6(R6(a.params.device));g.Mb(this.u,function(c){return c.equals(b)})||TTa(this.u,b);
break;case "remoteDisconnected":b=new T6(R6(a.params.device));g.Ub(this.u,function(c){return c.equals(b)});
break;case "gracefulDisconnect":break;case "playlistModified":eWa(this,a,"QUEUE_MODIFIED");break;case "nowPlaying":gWa(this,a);break;case "onStateChange":fWa(this,a);break;case "onAdStateChange":hWa(this,a);break;case "onVolumeChanged":iWa(this,a);break;case "onSubtitlesTrackChanged":dWa(this,a);break;case "nowAutoplaying":jWa(this,a);break;case "autoplayDismissed":this.ea("autoplayDismissed");break;case "autoplayUpNext":this.I=a.params.videoId||null;this.ea("autoplayUpNext",this.I);break;case "onAutoplayModeChanged":this.C=
a.params.autoplayMode;this.ea("autoplayModeChange",this.C);"DISABLED"==this.C&&this.ea("autoplayDismissed");break;case "onHasPreviousNextChanged":kWa(this,a);break;case "requestAssistedSignIn":this.ea("assistedSignInRequested",a.params.authCode);break;case "onLoopModeChanged":this.ea("loopModeChange",a.params.loopMode);break;default:Z8("Unrecognized action: "+a.action)}};
...
g.k.gs=function(a){Z8("Disconnecting with "+a);g.Ha("yt.mdx.remote.remoteClient_",null,void 0);a9(this);this.ea("beforeDisconnect",a);1==a&&e7();ZUa(this.i,a);this.dispose()};
...
g.k.iX=function(a,b){d9(this,a,b);bWa(this)};
...
g.k.KU=function(){g.Ee(this.C)||vWa(this,this.C);this.D=!1};
...
g.k.IO=function(){var a=this;if(z9(this)){var b=R8(this.Ub);this.events.tc(this.Z);b.muted?this.J.mute():this.J.unMute();this.J.setVolume(b.volume);this.Z=this.events.T(this.J,"onVolumeChange",function(c){tWa(a,c)})}};
...
g.k.Vb=function(a){this.B.stop();var b=this.I;if(!g.yJ(b,a)){var c=g.T(a,2);c!==g.T(this.I,2)&&this.J.Ft(c);this.I=a;xWa(this.u,b,a)}};g.v(C9,g.W);C9.prototype.Ad=function(){this.i.show()};
C9.prototype.Fb=function(){this.i.hide()};
C9.prototype.u=function(){S6("mdx-privacy-popup-cancel");this.Fb()};
C9.prototype.B=function(){S6("mdx-privacy-popup-confirm");this.Fb()};g.v(D9,g.W);D9.prototype.onStateChange=function(a){wWa(this,a.state)};g.v(E9,g.uP);E9.prototype.D=function(){var a=this.J.getOption("remote","receivers");a&&1<a.length&&!this.J.getOption("remote","quickCast")?(this.Eo=g.mc(a,this.i,this),g.vP(this,g.Ym(a,this.i)),a=this.J.getOption("remote","currentReceiver"),a=this.i(a),this.options[a]&&this.Vh(a),this.enable(!0)):this.enable(!1)};
E9.prototype.i=function(a){return a.key};
E9.prototype.jj=function(a){return"cast-selector-receiver"===a?"Transmitir\u2026":this.Eo[a].name};
...
g.k.create=function(){var a=this.player.V(),b=g.rE(a);a={device:"Desktop",app:"youtube-desktop",loadCastApiSetupScript:a.N("mdx_load_cast_api_bootstrap_script"),enableDialLoungeToken:a.N("enable_dial_short_lived_lounge_token"),enableCastLoungeToken:a.N("enable_cast_short_lived_lounge_token")};oWa(b,a);this.subscriptions.push(g.Av("yt-remote-before-disconnect",this.ZT,this));this.subscriptions.push(g.Av("yt-remote-connection-change",this.yV,this));this.subscriptions.push(g.Av("yt-remote-receiver-availability-change",this.QM,
...
g.k.load=function(){this.player.cancelPlayback();g.EM.prototype.load.call(this);this.Zh=new y9(this,this.player,this.Ub);var a=(a=sWa())?a.currentTime:0;var b=v9()?new Q8(p9(),void 0):null;0==a&&b&&(a=M8(R8(b)));0!==a&&this.Yb(a);xWa(this,this.Bd,this.Bd);this.player.Vk(6)};
...
g.k.QM=function(){var a=[this.Ok],b=a.concat,c=pWa();E8()&&g.wy("yt-remote-cast-available")&&c.push({key:"cast-selector-receiver",name:"Cast..."});this.Eo=b.call(a,c);a=q9()||this.Ok;H9(this,a);this.player.Oa("onMdxReceiversChange")};
